node {
	 ...
	 sh '''
      ...
      ##curl --header "X-Vault-Token: $VAULT_TOKEN" --request GET http://54.147.197.25:8200/v1/myengine/ssl1/cert

      ##curl --header "X-Vault-Token: $VAULT_TOKEN" --request GET http://54.147.197.25:8200/v1/myengine/ssl2/key
